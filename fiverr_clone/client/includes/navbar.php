<?php require_once 'E:/xampp/htdocs/fiverr_clone/client/classloader.php'; ?>
<nav class="navbar navbar-expand-lg navbar-dark p-4" style="background-color: #023E8A;">
  <a class="navbar-brand" href="/fiverr_clone/client/index.php">Client Panel</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="/fiverr_clone/client/project_offers_submitted.php">Project Offers Submitted </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/fiverr_clone/client/profile.php">Profile</a>
      </li>
      <?php
      ...
      ?>
      <li class="nav-item">
        <a class="nav-link" href="/fiverr_clone/client/core/handleForms.php?logoutUserBtn=1">Logout</a>
      </li>
    </ul>
  </div>
</nav>
