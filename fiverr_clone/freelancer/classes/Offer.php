...
class Offer extends Database {
   ...
   try {
       ...
       if ($e->getCode() == 23000) {
           echo "<script>alert('Your offer is already submitted. You cant submit another offer for this proposal *idiot*.'); window.history.back();</script>";
       } else {
           echo "<script>alert('There's an error occurred while submitting your offer. Please try again tomorrow.'); window.history.back();</script>";
       }
       return false; 
   }
   }
